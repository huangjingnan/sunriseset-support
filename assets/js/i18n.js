...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "features.f5.title": "离线可用",
      "features.f5.desc": "所有数据本地计算,无网络也能查看任意位置的日出日落。",
      "features.f6.title": "中英双语",
      "features.f6.desc": "完整中文与英文界面,自动跟随系统语言,也可手动切换。",
      "screenshots.eyebrow": "功能概览",
      ...
      "faq.a3":
        "解锁无限地图标记点,以及无广告体验。订阅周期包括月卡、年卡与终身买断,价格透明、无隐藏费用。",
      "faq.q4": "如何恢复已购买的订阅?",
      "faq.a4":
      ...
      "faq.a6":
        "非常欢迎!请通过页面下方的邮箱联系我们,或直接发送邮件至 350560713@qq.com。你的反馈会直接进入下一版本的开发任务。",
      ...
      "contact.cardTitle": "支持邮箱",
      "contact.cardDesc":
        "统一使用 QQ 邮箱,所有问题、建议、合作请发送至此邮箱。",
      "contact.email": "350560713@qq.com",
    ...
    en: {
      ...
      "hero.meta1": "Sunrise & Sunset Info",
      ...
      "features.f5.title": "Works Offline",
      "features.f5.desc":
        "All data is computed locally — check any location without a network connection.",
      "features.f6.title": "Bilingual",
      "features.f6.desc":
        "Full English & Chinese UI, with automatic language detection and manual switching.",
      "screenshots.eyebrow": "Features",
      ...
      "faq.a6":
        "We'd love to hear it! Use the email below or write to 350560713@qq.com. Your feedback goes straight into the next release.",
      ...
      "contact.cardTitle": "Support Email",
      "contact.cardDesc":
        "All questions, feedback and partnership inquiries should go to this address.",
      "contact.email": "350560713@qq.com",
